...
3. Identify the most consequential drift first. Make every finding specific enough to guide an edit.
4. Separate observed issues from uncertain inferences. Do not declare accessibility conformance from screenshots alone.

## `design-critic.md`

Write these headings: **Direction alignment**, **What holds**, **Drift**, **Priority fixes**, **Validation gaps**, and **Next pass**.
...
Use target-specific names, not a fixed `luxury` category. If a trait was not approved, do not score it. Keep the score secondary to the written critique and prioritized fixes.
